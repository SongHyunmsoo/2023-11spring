...
import org.choongang.entties.Member;
...
public interface MemberRepository extends CrudRepository<Member,Long> {
    ...
    List<Member> findByUserNmContainingOrderByRegDtDesc(String keyword1,String keyword2);

    Page<Member> findByUserNmContaining(String keyword2, Pageable pageable);
