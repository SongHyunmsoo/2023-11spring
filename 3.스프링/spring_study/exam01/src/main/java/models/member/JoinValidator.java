...
import commons.validators.Validator;
        ...
        public class JoinValidator implements Validator<Member>, RequiredValidator {
            ...
            public void validate(Member member) {
                ...
                chekRequired(userId, new BadRequestException("아이디를 입력하세요."));
                chekRequired(userPw, new BadRequestException("비밀번호를 입력하세요."));
                chekRequired(confirmPw, new BadRequestException("비밀번호를 확인하세요."));
                chekRequired(userNm, new BadRequestException("회원명을 입력하세요."));
                ...
                // 비밀번호, 비밀번호 확인시 일치 여부
                chekTrue(userPw.equals(confirmPw),
